#include "minishell.h"
//تحقق من اهلية كل متغير 
//يبدأ برقم او رمز غير _ يعني ممنوع 
//رقم في الوسط او نهاية مسموح لكن رموز في الوسط ممنوعة
//حين نستخدم += يجب دمج القيمة الجديدة بالقديمة في سترينغ واحد 
// دعم رسائل الخطأ و حالة الخروج 
//"hello=world" 
